...
/* No title or description here on purpose: the root layout's `title.default`
   is already the wordmark and tagline, which is exactly what the home tab
   should read, and its canonical and alternates already describe "/". Setting
   a title here would be fed through that layout's template and come back as
   "Haven — … · Haven". */
