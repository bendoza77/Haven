...
const config = consoles.moderator;
...
export default async function ModeratorNewProductPage() {
  const t = await getTranslations("console");
  ...
  return (
    <div className="space-y-8">
      <ConsoleHeader
        ...
        description={t("products.newDescriptionModerator")}
      />

      <ProductForm config={config} submitLabel={t("actions.addProduct")} />
    </div>
  );
}
