...
productRouter.post("/:id/reviews", protect, createReview);
...
productRouter.post("/upload", allowed("admin", "moderator"), uploadImages, handleUploadErrors, uploadProductImages);
